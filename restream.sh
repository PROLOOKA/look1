...
-map "[v1out]" -c:v:0 libx264 -b:v:0 2500k -preset veryfast -g 48 -keyint_min 48 -sc_threshold 0 \
-map "[v2out]" -c:v:1 libx264 -b:v:1 1000k -preset veryfast -g 48 -keyint_min 48 -sc_threshold 0 \
-map "[v3out]" -c:v:2 libx264 -b:v:2 600k -preset veryfast -g 48 -keyint_min 48 -sc_threshold 0 \
