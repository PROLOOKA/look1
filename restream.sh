...
SOURCE_URL="http://ipro.premium-ott3.com/live/celesi83/1737467/461659.m3u8"
LOGO_URL="https://up6.cc/2026/06/178065057949411.png"

wget -O logo.png "$LOGO_URL"

ffmpeg -re -user_agent "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36" -i "$SOURCE_URL" -i logo.png \
-filter_complex \
"[1:v]scale=100:-1[logo];[0:v][logo]overlay=10:main_h-overlay_h-10[v_logo];[v_logo]split=3[v1][v2][v3];[v1]scale=1280:720[v1out];[v2]scale=854:480[v2out];[v3]scale=640:360[v3out]" \
